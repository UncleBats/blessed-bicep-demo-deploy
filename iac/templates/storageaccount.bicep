...
resource storageAccountContainers 'Microsoft.Storage/storageAccounts/blobServices/containers@2023-04-01' = [for container in containers : if(!empty(containers)) {
